...
const TaskModal = () => {
  ...
  return (
    <div
      ...
      } top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col gap-6 absolute z-20 w-[343px] md:w-[480px] p-[24px] md:p-[32px] rounded-[6px]`}
    >
      ...
      <ButtonPurple text={'Save Changes'} onClick={saveChangesOnClick} />
    </div>
  );
};
