    ...
    <>
      {isMobile ? (
        <button
          ...
          className="w-[48px] h-[32px] bg-purpleColor  flex items-center justify-center rounded-[45%] ml-16 cursor-pointer "
        >
        ...
        <button
          onClick={handleClick}
          className="bg-purpleColor hover:bg-purpleHover text-white w-44 h-12 rounded-3xl flex items-center justify-center font-bold text-[15px]"
        >
          + Add New Task
        </button>
      )}
