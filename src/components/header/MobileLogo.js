...
const MobileLogo = ( {margins} ) => {
  ...
  return (
    <div className={`flex items-center ${margins} xl:w-[276px] md:w-[248px] md:h-[80px] xl:h-[96px] md:border-r md:border-solid ${isDarkMode ? "md:border-linesDark" : "md:border-linesLight"}`}>
