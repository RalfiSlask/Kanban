...
const BoardSection = () => {
  ...
  return (
    <div className={`
      ...
      ${isMobile ? "static mt-6" : "absolute overflow-x-auto transition-paddingLeft duration-1000 ease-in-out"}  min-h-[600px] lex justify-center md:top-28 xl:top-32 w-[100%]`}>
