...
const ColumnBall = ( {id} ) => {
    ...
    const [colorsArray, setColorsArray] = useState([{id: 0, color: "#49C4E5"},{id: 1, color: "#8471F2"},{id: 2, color: "#67E2AE"}])
  ...
  return (
    <div className="rounded-full w-[15px] h-[15px]" style={{backgroundColor: color}}></div>
  )
}
