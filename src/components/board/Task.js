...
const Task = ( {task, id, columnId} ) => {
  ...
  return (
    <>
    <div onClick={handleClick} className={`${isDarkMode ? "bg-darkGrey text-white shadow-darkShadow" : "bg-white text-black shadow-lightShadow"} cursor-pointer rounded-[8px] w-full min-h-[px] py-[23px] px-[16px] flex flex-col gap-2`}>
